...
/* NOYAU sans i18n : ce module ne dépend d'AUCUN runtime i18n (pas d'import de
   i18n/config.js → pas d'import JSON de locale). Il est donc importable côté
   serverless (fonction Vercel du rapport PDF) où l'ESM natif de Node refuse les
   imports JSON sans attribut « with { type: json } ». Le libellé traduit de
   catégorie (catLabel) vit dans top14.js, qui ré-exporte ce noyau + i18n. */
