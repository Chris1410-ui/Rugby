  ...
  return (
    <div>
      ...
      <Section title="PORTABILITÉ">
        ...
        <button onClick={doExport} disabled={exporting} style={{ width: "100%", background: C.blue, border: "none", borderRadius: 10, padding: 12, color: "#fff", fontWeight: 800, fontSize: 13, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, opacity: exporting ? 0.6 : 1 }}>
      ...
      <Section title="DROIT À L'EFFACEMENT">
        ...
        {!confirm ? (
          <button onClick={() => { setConfirm(true); setErr(""); }} style={{ width: "100%", background: "transparent", border: `1px solid ${C.coral}`, borderRadius: 10, padding: 12, color: C.coral, fontWeight: 800, fontSize: 13, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
