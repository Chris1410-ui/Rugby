...
import { normalizeBlocks } from "../lib/sessionBlocks.js";
...
/* Séances libres (autonomes) créées par le joueur — cf. migrations 0054/0110/0111.
   ...
   Les normaliseurs de blocs (par kind) vivent dans lib/sessionBlocks.js (purs,
   partagés avec la matérialisation des protocoles). Alias historique conservé. */

// Alias rétro-compatible (nom d'origine) → normaliseur pur partagé.
export const normalizeFreeExercises = normalizeBlocks;
